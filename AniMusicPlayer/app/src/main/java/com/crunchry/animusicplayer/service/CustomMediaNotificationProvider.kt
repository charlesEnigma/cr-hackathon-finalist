...
import com.crunchry.animusicplayer.data.NO_ARTIST_TEXT
import com.crunchry.animusicplayer.data.NO_TITLE_TEXT
import com.crunchry.animusicplayer.data.PLAY_PAUSE_BUTTON_TEXT
import com.crunchry.animusicplayer.data.STOP_BUTTON_TEXT
...
class CustomMediaNotificationProvider(
    ...
    override fun createNotification(
        ...
        remoteViews.setTextViewText(R.id.notification_title, metadata.title ?: NO_TITLE_TEXT)
        remoteViews.setTextViewText(R.id.notification_artist, metadata.artist ?: NO_ARTIST_TEXT)
    ...
    private fun buildNotification(
        ...
        return NotificationCompat
            .Builder(context, AniMusicPlayerApplication.MEDIA_CHANNEL_ID)
